...
public class CustomFBLoginButton extends Button{
	 ...
	 private static final String TAG = CustomFBLoginButton.class.getName();
	    ...
	    private CustomFBLoginButtonProperties properties = new CustomFBLoginButtonProperties();

	    static class CustomFBLoginButtonProperties {
	    ...
	    public CustomFBLoginButton(Context context, AttributeSet attrs) {
	        ...
	        if (attrs.getStyleAttribute() == 0) {
	            ...
	            if(isInEditMode()) {
	                ...
	                this.setBackgroundResource(R.drawable.com_facebook_loginbutton_custom);
	                initializeActiveSessionWithCachedToken(context);
	            }
	        }
	    }
	    ...
	    void setProperties(CustomFBLoginButtonProperties properties) {
